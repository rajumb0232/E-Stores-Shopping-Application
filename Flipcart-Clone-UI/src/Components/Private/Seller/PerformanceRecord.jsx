...
import DataCartBtn from "./DataCartBtn";

const PerformanceRecord = () => {
  return (
    <div className="mt-18 w-full flex flex-col justify-center bg-stone-50 items-start">
      {/* ORDERS */}
      ...
      {/* PRODUCT LISTING */}
      <div className="h-max w-full px-4 py-2 hover:bg-white border-b-4">
        <p className="text-slate-700 font-semibold w-full pb-4">Product Listing</p>
      ...
      <div className="h-max w-full px-4 py-2 hover:bg-white border-b-4">
        ...
        <div className="w-full h-96 py-2 border-t-2 flex justify-around items-center text-slate-300 font-semibold">No data</div>
      </div>
      {/* TRENDING */}
      <div className="h-max w-full px-4 py-2 hover:bg-white border-b-4">
        <p className="text-slate-700 font-semibold w-full pb-4">Trending products</p>
        <div className="w-full h-96 py-2 border-t-2 flex justify-around items-center text-slate-300 font-semibold">No data</div>
      </div>
    </div>
  );
