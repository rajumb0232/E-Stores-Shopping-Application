...
const RadioBtn = ({ value, setter, state }) => {
  return (
      ...
      <div className="w-full flex justify-start items-center">
        ...
        <div className="w-1/6 flex justify-start items-center">
          <button
            ...
            type="button"
          >
            <div className={`h-4 w-4 rounded-xl bg-white flex justify-center items-center text-sm  font-extrabold transition-transform duration-300 ${(state)? "text-amber-400 origin-right translate-x-full" : "text-gray-300"}`}>
